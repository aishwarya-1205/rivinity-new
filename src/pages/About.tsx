    ...
    const values = [
        {
            ...
            description: "We believe AI should empower people, not replace them. Our solutions are designed with empathy and ethical considerations at their core."
        },
        {
            icon: <Target className="w-6 h-6 text-primary" />,
            title: "Precision & Excellence",
            description: "From fine-tuning LLMs to architecting neural networks, we strive for the highest level of accuracy and performance in every line of code."
        },
        {
            icon: <Globe2 className="w-6 h-6 text-primary" />,
            title: "Sovereign Innovation",
            description: "We are committed to building AI that respects data sovereignty and cultural nuances, specifically tailored for the Indian landscape."
        }
    ];

    const milestones = [
        { year: "2023", title: "The Inception", description: "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod." },
        { year: "2024", title: "IndicLLM Launch", description: "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod." },
        { year: "2025", title: "Development", description: "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod." },
        { year: "2026", title: "Global Recognition", description: "lorem ipsum dolor sit amet consectetur adipisicing elit. Quisquam, quod." }
    ];
        ...
        <div className="min-h-screen bg-background text-foreground overflow-hidden">
            ...
            <section className="relative pt-40 pb-20 lg:pt-48 lg:pb-32 px-4 overflow-visible">
                ...
                <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[900px] h-[900px] z-0 opacity-[0.3] dark:opacity-[0.25]">
                    ...
                    >
                        <circle cx="100" cy="100" r="95" fill="none" stroke="currentColor" strokeWidth="0.2" strokeDasharray="4 4" />
                        <circle cx="100" cy="100" r="75" fill="none" stroke="currentColor" strokeWidth="0.3" />
                        {[...Array(18)].map((_, i) => (
                            <path
                                key={i}
                ...
                <div className="max-w-7xl mx-auto text-center relative z-10">
                    ...
                    >
                        ...
                        <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed font-medium">
                            We are building the sovereign AI layer for India, blending ancient wisdom with future-ready neural intelligence.
                        </p>
                    </motion.div>
                </div>
            </section>
                ...
                <div className="max-w-6xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                    ...
                    >
                        <div className="flex items-center gap-3 mb-6">
                            ...
                            <span className="text-orange-500 font-bold uppercase tracking-[0.3em] text-xs">Legacy & Vision</span>
                        </div>
                        <h2 className="text-4xl md:text-5xl font-bold mb-8 font-display">Our <span className="text-primary">Story</span></h2>
            ...
            <section className="py-32 px-4 relative overflow-hidden">
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-20">
                        ...
                        <h2 className="text-4xl md:text-6xl font-bold mb-4 font-display">The <span className="gradient-text">Rivinity Ideals</span></h2>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                        {values.map((value, idx) => (
                            ...
                            >
                                ...
                                <h3 className="text-2xl font-bold mb-4 group-hover:text-orange-600 dark:group-hover:text-orange-400 transition-colors">{value.title}</h3>
            ...
            <section className="py-32 px-4 relative overflow-hidden bg-slate-50/30 dark:bg-slate-900/30">
                <div className="max-w-7xl mx-auto relative z-10">
                    <div className="text-center mb-24">
                        ...
                        >
                            <h2 className="text-4xl md:text-6xl font-bold tracking-tight font-display">
                                The <span className="text-primary">Team</span> Behind Our Product
                            </h2>
                            <p className="text-muted-foreground max-w-2xl mx-auto leading-relaxed">
                                At Rivinity, our Bharat-driven team is dedicated to building sovereign AI that respects our heritage while leading global innovation.
                            </p>
                        </motion.div>
                    </div>
                    ...
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
                        {[
                            { name: "XYZ", role: "Software Engineer", img: "https://images.unsplash.com/photo-1506794778202-cad84cf45f1d" },
                            { name: "ABC", role: "Product Designer", img: "https://images.unsplash.com/photo-1494790108377-be9c29b29330" },
                            { name: "DEF", role: "AI Research", img: "https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d" },
                            { name: "GHI", role: "Marketing Lead", img: "https://images.unsplash.com/photo-1534528741775-53994a69daeb" }
                        ].map((member, idx) => (
                            <motion.div
                                key={idx}
                                initial={{ opacity: 0, y: 20 }}
                ...
                <div className="max-w-7xl mx-auto">
                    <div className="text-center mb-24">
                        ...
                        >
                            ...
                            <p className="text-muted-foreground uppercase tracking-[0.3em] text-xs font-bold">The dynamic team driving innovation for Bharat</p>
                        </motion.div>
                    </div>

                    <div className="grid grid-cols-1 md:grid-cols-2 gap-12 max-w-5xl mx-auto">
                        {[
                            { name: "ABC", role: "Founder Rivinity", img: "/assets/founder_aryan.png" },
                            { name: "XYZ", role: "Co-Founder Rivinity", img: "/assets/founder_kiara.png" }
                        ].map((founder, idx) => (
                            <motion.div
                                key={idx}
                            ...
                            >
                                <div className="space-y-8 text-center flex flex-col items-center">
                                    ...
                                    <div className="space-y-2">
                                        <h3 className="text-3xl font-bold tracking-tight">{founder.name}</h3>
                    ...
                    {milestones.map((ms, idx) => (
                        ...
                        >
                            ...
                            <div className="flex-1">
                                ...
                                <p className="text-muted-foreground text-lg">{ms.description}</p>
                            </div>
                        </motion.div>
                    ))}
                </div>
