...
const services = [
  {
    ...
    title: "Development",
    description:
      "We build tailored AI solutions that integrate seamlessly into your existing infrastructure. From custom LLMs to computer vision systems, our development process is agile and security-focused.",
    link: "#",
  },
  {
    ...
    description:
      "Robust and scalable data pipelines ensuring your AI models are fed with high-quality, real-time data. We handle the complexity of big data alignment and processing.",
    link: "#",
  },
  {
    ...
    description:
      "Navigating the AI landscape can be complex. We provide strategic roadmaps, feasibility studies, and use-case identification to ensure your AI investment delivers real ROI.",
    link: "#",
  },
  {
    ...
    description:
      "Beyond off-the-shelf models, we train and fine-tune architectures specifically for your domain data, ensuring higher accuracy and relevance for your business needs.",
    link: "#",
  },
  {
    ...
    description:
      "Secure, compliant, and localized cloud infrastructure designed for sensitive data. Keep your data within borders without sacrificing performance or scalability.",
    link: "#",
  },
  {
    ...
    description:
      "Transform raw data into future insights. Our predictive models help you anticipate market trends, customer behavior, and operational risks before they happen.",
    link: "#",
  },
];
...
const features = [
  {
    ...
    description:
      "Automate complex workflows and reduce operational costs with intelligent agents.",
  },
  {
    icon: <Shield className="w-5 h-5" />,
    title: "Scalable Solutions",
    description:
      "Architecture that grows with your business, from pilot to enterprise-scale.",
  },
  {
    icon: <TrendingUp className="w-5 h-5" />,
    title: "Data-Driven Decisions",
    description:
      "Turn intuition into evidence-based strategy with deep learning analytics.",
  },
  {
    icon: <Lock className="w-5 h-5" />,
    title: "Secure Processing",
    description:
      "Enterprise-grade security protocols ensuring your proprietary data remains safe.",
  },
];
...
const testimonials = [
  {
    quote:
      "Partnering with Rivinity has completely transformed our data infrastructure. Their Sovereign Cloud solution gave us the security we needed with the speed we dreamed of.",
    author: "Priya Menon",
  ...
  {
    quote:
      "The custom LLM they developed for our customer support reduced response times by 60%. The team's expertise in Indic languages is unmatched in the industry.",
    author: "Rahul Verma",
        ...
        <div className="max-w-7xl mx-auto text-center relative z-10">
          ...
          >
            ...
            <p className="text-lg md:text-xl text-muted-foreground max-w-3xl mx-auto mb-10 leading-relaxed">
              Empowering Business Transformation With{" "}
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-x-16 gap-y-24">
          {services.map((service, index) => (
            ...
            >
              ...
              <a
                href={service.link}
                className="text-primary font-medium text-sm flex items-center hover:underline mt-2"
              >
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <h2 className="text-3xl md:text-5xl font-bold mt-2">
              Why Choose <span className="text-foreground">Rivinity</span>
            </h2>
            <p className="text-muted-foreground mt-4 max-w-2xl mx-auto">
              Pioneering the future of AI with solutions that are secure,
              scalable, and tailored to your unique challenges.
            </p>
          </div>
